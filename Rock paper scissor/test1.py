...
def main():
    ...
    stateResult = False
    startGame = False
    isGameRunning = True  # Variable to track whether the game is running or not
    scores = [0, 0]  # [AI, Player]

    while isGameRunning:  # Use the isGameRunning variable to control the game loop
        ...
        if key == ord('s'):
            ...
            stateResult = False
        elif key == ord('q'):  # Check for 'q' key press to stop the game
            isGameRunning = False
